...
export default class BookShelf extends React.Component {
	...
	render() {
		return (
			<div>
				{
					// This loop creates the selves based on the number of this.state.bookshelfTitles
					this.state.bookshelfTitles.map((title) => {
						return (
							<div className="bookshelf">
								<h2 className="bookshelf-title">{title}</h2>
								<div className="bookshelf-books">

									{/* This is the list of books per shelf */}
									<ListOfBooksPerShelf title={title} />
								</div>
							</div>
						)
					})
